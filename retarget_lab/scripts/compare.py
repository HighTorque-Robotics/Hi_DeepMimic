...
robot_config.default_J *= 0.5
robot_config.default_J[0][:, 1] += 0.11
robot_config.default_J[0][:, 2] -= 0.015
robot_config.default_J[0][:, 0] *= 1.4
robot_config.default_J[0][smpl_joint_pick_idx, :] = torch.tensor(positions[link_pick_idx, :]).float()
robot_config.default_J[0][SMPL_BONE_ORDER_NAMES.index("L_Wrist"), 0] -= 0.1
robot_config.default_J[0][SMPL_BONE_ORDER_NAMES.index("R_Wrist"), 0] += 0.1
robot_config.default_J[0][SMPL_BONE_ORDER_NAMES.index("L_Wrist"), 2] += 0.04
robot_config.default_J[0][SMPL_BONE_ORDER_NAMES.index("R_Wrist"), 2] += 0.04
