...
# amass_data = load_amass_data("data/AMASS/AMASS_Complete/ACCAD/Female1Gestures_c3d/D6- CartWheel_poses.npz") # 侧空翻
amass_data = load_amass_data("data/from_video/mgg_walk.npz") # 行走
...
# amass_data = load_amass_data("data/AMASS/AMASS_Complete/ACCAD/Female1General_c3d/A7 - crouch_poses.npz")
